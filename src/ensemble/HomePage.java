                    ...
                    case Highlights:
                        if (oldRowType != RowType.Highlights) {
                            ...
                            if (highlightRibbon == null) {
                                //highlightRibbon = new ImageView(new Image(getClass().getResource("src/highlights-ribbon.png").toExternalForm()));
                            	highlightRibbon = new ImageView(new Image("highlights-ribbon.png"));
